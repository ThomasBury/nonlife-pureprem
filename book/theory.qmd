...
## Why the pure-premium Tweedie uses exposure as its weight
...
## Why this is not the same as forcing common dispersion on aggregate loss
...
## Poisson counts with exposure offset versus claim-frequency rates with exposure weight
