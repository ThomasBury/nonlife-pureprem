...
with exposure weights. It includes:
...
These examples use a common dispersion for Tweedie totals. The compound
Poisson–Gamma process in the theory chapter uses a dispersion that varies with
exposure. See that chapter and the pure-premium tutorial for the corresponding
exposure weights.
