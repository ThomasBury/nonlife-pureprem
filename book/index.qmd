...
The **Boost from average** chapter isolates the operational caveat that
`boost_from_average` must be disabled when using `init_score = log(exposure)`.
...
cd book && quarto render     # render this book
```
